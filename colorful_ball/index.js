...
let ballArr = [];
document.onmousemove = throttleByTimer(function (e) {
...
SmallBall.prototype = {
    ...
    drawBall: function () {
        ...
        ctx.closePath();
        ctx.fillStyle = "rgb(" + parseInt(Math.random() * 256) + "," +
            parseInt(Math.random() * 256) + "," + parseInt(Math.random() * 256) + "," + parseInt(Math.random() * 2) + ")";
        ctx.fill();
    }
};
